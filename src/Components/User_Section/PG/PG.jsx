...
//   const [filteredData, setFilteredData] = useState(pgData);
...
//         ? pg.city.toLowerCase().includes(formData.city.toLowerCase())
//         : true;
//       const bedroomMatch = formData.bedrooms
//         ? (formData.bedrooms === "4"
//             ? pg.bedrooms >= 4
//             : pg.bedrooms === parseInt(formData.bedrooms))
//         : true;
//       const priceMatch = (() => {
...
//       {/* Filter Section - styled like Hotel_Banqute */}
//       <div
...
//                     <FaBed /> {pg.bedrooms || "N/A"}
//                   </span>
//                   <span className="flex items-center gap-1">
//                     <FaCar /> {pg.parking || "N/A"}
//                   </span>
//                   <span className="flex items-center gap-1">
//                     <FaRulerCombined /> {pg.area || "N/A"} sq.ft.
//                   </span>
//                 </div>
...
//                   <span className="flex items-center gap-1">
//                     <FaUser /> {pg.owner || "Admin"}
//                   </span>
//                   <span className="flex items-center gap-1">
//                     <FaCalendarAlt /> {pg.date || "01/01/2024"}
//                   </span>
//                 </div>
//               </div>
//             </div>
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const pgOnly = json?.properties?.filter(
          (item) => item.type?.toLowerCase() === "room"
        );
        setPgData(pgOnly || []);
        setFilteredData(pgOnly || []);
      } catch (err) {
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="flex justify-between text-xs text-gray-500">
                  ...
                  <span className="flex items-center gap-1">
                    <FaCalendarAlt /> {new Date(pg.createdAt).toLocaleDateString()}
                  </span>
                </div>
              </div>
            </div>
