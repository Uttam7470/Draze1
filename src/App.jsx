...
import Hotel from "./Components/User_Section/Hotel_Banqute/Hotel.jsx";
import HotelDetail from "./Components/User_Section/Hotel_Banqute/HotelDetail.jsx";

import Banqute from "./Components/User_Section/Hotel_Banqute/Banqute.jsx";
import BanquetDetail from "./Components/User_Section/Hotel_Banqute/BanquteDetail.jsx";
...
{/* 
                    ...
                    <Route path="/banqutes" element={<Banqute />} />
                   
                    <Route
                      path="/hotel/:id"
                      element={<Hotel_BanquteDetails />}
                    />
                    <Route
                      path="/banquet/:id"
                      element={<Hotel_BanquteDetails />}
